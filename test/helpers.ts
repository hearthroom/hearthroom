...
export async function resetDb(): Promise<void> {
  for (const table of ["member_conversations", "library_metrics", "member_favorites", "member_follows", "hosting_versions", "avatar_cleanup", "work_copies", "works", "member_connections", "card_saves", "comment_likes", "comments", "game_worlds", "cards", "card_numbers", "card_registrations", "review_stamps", "review_snapshots", "review_submissions", "reviewers", "member_identities", "members"]) {
