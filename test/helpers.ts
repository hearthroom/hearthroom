...
export async function resetDb(): Promise<void> {
  for (const table of ["community_review_signal", "community_case_jobs", "community_notifications", "community_metrics", "community_nonces", "community_awards", "community_xp", "discord_link_attempts", "discord_links", "community_subjects", "community_preferences", "member_conversations", "library_metrics", "member_favorites", "member_follows", "hosting_versions", "avatar_cleanup", "work_copies", "works", "member_connections", "card_saves", "comment_likes", "comments", "game_worlds", "cards", "card_numbers", "card_registrations", "review_stamps", "review_snapshots", "review_submissions", "reviewers", "member_identities", "members", "moderation_blocked_versions", "moderation_votes", "moderation_cases", "moderation_compensation", "moderation_events", "moderation_state", "moderation_metrics"]) {
