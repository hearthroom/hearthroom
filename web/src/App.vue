  ...
  <footer v-if="SITE.repoUrl && !route.meta.bare" class="footer">
    <div class="footer__inner">
      ...
      <nav class="footer__links" :aria-label="$t('footer.links')">
        <a v-if="discordInvite" class="footer__discord" :href="discordInvite" target="_blank" rel="noopener noreferrer">{{$t("community.join")}}</a>
...
.footer__discord { display:inline-flex;align-items:center;min-height:44px; }
