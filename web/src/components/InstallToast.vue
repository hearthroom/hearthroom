    ...
    <section v-if="installPrompt.visible" class="install" role="region" :aria-label="$t('pwa.install.title')">
      <div class="install__row">
        <span class="install__tile" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M5 3h14a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3h-7.5L7 21.5V18H5a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3z" /></svg>
        </span>
        <div class="install__text">
          <p class="install__title">{{ $t("pwa.install.title") }}</p>
          <p class="install__body">{{ installPrompt.kind === "ios" ? $t("pwa.install.ios") : $t("pwa.install.body") }}</p>
        </div>
